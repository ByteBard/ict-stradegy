...
改进依据 (纯IS决策, OOS独立验证):
  Detector剪枝 (审计修复: 决策仅基于IS 2009-2019):
    star (晨星/暮星): IS-LOO ΔSh=+0.035 → IS噪声, OOS独立验证ΔSh=+0.084 ✓
    dbl_top_bot (双顶双底): IS-LOO ΔSh=+0.041 → IS噪声, OOS独立验证ΔSh=+0.020 (中性)
    剪枝后: IS_Sh 0.713→0.786(+0.073), OOS_Sh 0.911→1.004(+0.093)
    保留6个detector的IS-LOO ΔSh均为负(核心/中性)
